                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <form method="GET" action="{{ route('laporan.kasusBelumIntervensi') }}">
                                ...
                                <div class="table-responsive table-fixed">
                                    ...
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($laporanbelumIntervensi as $stunting)
                                            <tr>
                                    ...
                                    {{-- <caption>Showing data from {{ $laporanbelumIntervensi->firstItem() }} to {{ $laporanbelumIntervensi->lastItem() }} of {{ $laporanbelumIntervensi->total() }} data.</caption> --}}
                                </div>
                                <div class="float-right">
                                    {{ $laporanbelumIntervensi->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
