                ...
                <div class="card">
                    <form action="{{ route('bapakasuhs.update', $bapakasuh->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>No. HP</label>
                                <input type="number" class="form-control" name="NOHP" value="{{ $bapakasuh->NOHP }}">
                            </div>
                        </div>
