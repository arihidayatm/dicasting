                                ...
                                <form wire:submit.prevent="store">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" class="form-control @error('ALAMAT') is-invalid @enderror" id="ALAMAT" name="ALAMAT" wire:model="ALAMAT" placeholder="Alamat lengkap">
                                            @error('ALAMAT')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control @error('RT') is-invalid @enderror" id="RT" name="RT" wire:model="RT" placeholder="000">
                                            @error('RT')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control @error('RW') is-invalid @enderror" id="RW" name="RW" wire:model="RW" placeholder="000">
                                            @error('RW')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    {{-- Kabupaten/Kota, Kecamatan, kelurahan/desa  dengan pilihan sesuai dengan table di database KABUPATEN_ID, KECAMATAN_ID, KELURAHANDESA_ID --}}
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control @error('KODE_POS') is-invalid @enderror" id="KODE_POS" name="KODE_POS" wire:model="KODE_POS" placeholder="24111">
                                            @error('KODE_POS')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('NOHP') is-invalid @enderror" id="NOHP" name="NOHP" wire:model="NOHP" placeholder="081363000001">
                                            @error('NOHP')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
